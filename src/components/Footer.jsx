...
function Footer() {
  return (
    <div  className="relative h-screen w-full px-14 text-zinc-900 py-20 flex">
      <div className=' w-1/2 font-["Avenir_Next_Condensed"] uppercase text-[6.8vw] leading-none tracking-tighter font-semibold'>
        <h1>eye-</h1>
        <h1>opening</h1>
        <div className="logo absolute top-[80%]">
          <svg
            width="72"
            height="30"
            viewBox="0 0 72 30"
      ...
      <div>
        <h1 className="uppercase text-[6.8vw] font-['Avenir_Next_Condensed'] leading-none tracking-[-7px] font-semibold">
          Presentations
        </h1>
        <div className="flex">
          <div className="flex flex-col font-['Neue_Montreal'] font-[550]">
            <div className="flex flex-col mt-10">
              ...
              {["Instagram", "Behance", "Facebook", "LinkedIn"].map(
                (item, index) => (
                  <a
                    key={index}
                    className={`underline  ${index === 0 && "mt-4"}`}
                  >
                    {item}
                  </a>
                )
            ...
            <div className="flex flex-col mt-8">
              L:
              {["202-1965 W 4th Ave", "Vancouver Canada", "302 Chukani Street", "Liviv Ukraine"].map(
                (item, index) => (
                  <a
                    key={index}
                    className={`underline  ${index === 0 && "mt-4"} ${index === 2 && "mt-4"} `}
                  >
                    {item}
                  </a>
                )
          ...
          <div className="flex flex-col mt-[42%] ml-[75%] font-['Neue_Montreal'] font-[550]">
              M:
              {["Home", "Services", "Insight", "Work" , "Contact"].map(
                (item, index) => (
                  <a
                    key={index}
                    className={`underline  ${index === 0 && "mt-4"}`}
